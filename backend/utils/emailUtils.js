...
class EmailUtils {
  ...
  async sendOtpEmail(to, otp) {
    try {
      // CRITICAL: If email service is not configured, throw error instead of logging OTP
      ...
      // CRITICAL: Never log OTP to console in production
      if (process.env.NODE_ENV === 'development') {
        console.log(`[DEV] OTP for ${to}: ${otp} (development mode only)`);
      }
